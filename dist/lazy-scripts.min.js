...
/**
     ...
     */
function i(e,t){var n=e.shift();if(n&&-1===c.indexOf(n)){var r=document.createElement("script");c.push(n),r.type="text/javascript",r.src=n,0<e.length&&(r.onload=function(){i(e,t)}),t.appendChild(r)}else 0<n.length&&i(e,t)}
/**
