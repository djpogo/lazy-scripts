...
/**
     ...
     */
function a(e,t){var n=e.shift();if(n&&-1===c.indexOf(n)){var r=document.createElement("script");c.push(n),r.type="text/javascript",r.src=n,0<e.length&&(r.onload=function(){a(e,t)}),t.appendChild(r)}else 0<e.length&&a(e,t)}
/**
...
/**
     ...
     */function l(){o.forEach(function(e){return u(e)})}
/**
...
/**
     ...
     */
function(){if(document.querySelectorAll("script").forEach(function(e){c.push(e.src)}),n=i(e.lazyScriptSelector),r=i(e.lazyScriptsSelector),window.IntersectionObserver){var t=new IntersectionObserver(function(e,t){return function(e,t){e.forEach(function(e){e.isIntersecting&&(u(e.target),t.unobserve(e.target))})}(e,t)},e.intersectionObserverOptions);o.forEach(function(e){t.observe(e)})}else window.requestAnimationFrame?window.requestAnimationFrame(function(){return l()}):l()}()}});
